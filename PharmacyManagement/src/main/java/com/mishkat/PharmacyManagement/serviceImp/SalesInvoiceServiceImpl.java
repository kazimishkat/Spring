...
public class SalesInvoiceServiceImpl implements SalesInvoiceService {
    ...
    public SalesInvoiceResponseDto createInvoice(SalesInvoiceRequestDto dto) {
        ...
        if (invoice.getItems() != null && dto.getItems() != null) {
            for (int i = 0; i < invoice.getItems().size(); i++) {
                ...
                // Line Total হিসাব করা (ম্যাপারের ইনস্ট্রাকশন অনুযায়ী)
    ...
    public SalesInvoiceResponseDto updateInvoice(Long id, SalesInvoiceRequestDto dto) {
        ...
        // সাধারণত ইনভয়েস পুরোপুরি আপডেট করা হয় না, তবে CRUD স্ট্যান্ডার্ড অনুযায়ী দেওয়া হলো।
        ...
        // Orphan Removal লজিক ব্যবহার করে আইটেম আপডেট করা
    ...
    // =========================================================================
    // Helper Method for Line Total Calculation
    // =========================================================================
    private BigDecimal calculateLineTotalWithDiscount(BigDecimal baseTotal, DiscountType type, BigDecimal discountValue) {
        ...
        // আপনার সিস্টেমে DiscountType Enum এ "FLAT" বা "PERCENTAGE" থাকলে সেই অনুযায়ী ক্যালকুলেশন হবে
        if (type.name().equalsIgnoreCase("PERCENTAGE")) {
            ...
            // ধরে নেওয়া হচ্ছে অন্যথায় এটি FLAT ডিসকাউন্ট
